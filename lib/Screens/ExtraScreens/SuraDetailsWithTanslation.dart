...
class SuraDetailWithTranslationScreen extends StatefulWidget {

  int surahNumber=1;

  @override
  _SuraDetailWithTranslationScreenState createState() => _SuraDetailWithTranslationScreenState();
}

class _SuraDetailWithTranslationScreenState extends State<SuraDetailWithTranslationScreen> {
